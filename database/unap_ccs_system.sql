...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-10-2024 a las 15:20:58
...
--
ALTER TABLE `actualizacionescapacitaciones`
  MODIFY `id_capacitacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `participaciontesis`
  MODIFY `id_participaciontesis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `reconocimientos`
  MODIFY `id_reconocimiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
