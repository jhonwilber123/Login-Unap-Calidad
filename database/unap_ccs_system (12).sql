...
-- Tiempo de generación: 05-12-2024 a las 15:48:48
...
(1, 1, '2024-I', 'Contratado', 20.00, 20.00, 20.00, '1733334298_Chi_cuadrado.pdf'),
...
--
ALTER TABLE `acreditacionlicenciamiento`
  MODIFY `id_acreditacion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `carga_academica_lectiva`
  MODIFY `id_carga` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `imagenesadjuntas`
  MODIFY `id_imagen` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=135;
